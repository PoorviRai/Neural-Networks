...
sys.path.append('E:/Sem 3/NN/Assignments/hw03')
import network2 as network2
import mnist_loader as loader
import activation as act
from matplotlib import pyplot as plt

DATA_PATH = 'E:/Sem 3/NN/Assignments/hw03/data/'
...
def main():
    ...
    Train_acc = [x / len(train_data[0]) for x in history[3]]
    Valid_acc = [x / len(valid_data[0]) for x in history[1]]
    ...
    net = network2.load('SGD_model');
    print("Test Set Accuracy", net.accuracy(test_data)/len(test_data[0]))
